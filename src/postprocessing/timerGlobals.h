...
public:
    ...
    bool stopUsingSpecificity;
    int requiredSpecificityLiterals;
    double requiredSpecificityVolume;

    double probLocalSearch;
    int doRuleCleaning;
    int doRuleSplitting;
    int doRuleGeneralizing;
    int lsCombinationToUse;

    double expectedNonNoiseAmmount;
